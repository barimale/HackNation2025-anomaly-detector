...
namespace UploadStreamToQuestDB.API.Controllers {
    ...
    public class DataController : Controller {
        ...
        [HttpGet("data/ranking")]
        [SwaggerOperation(Summary = "Endpoint for getting ranking data from server.")]
        public async Task<IActionResult> GetRanking() {
           var ranks = await rankingRepository.GetAllAsync(string.Empty, default);

            return Ok(ranks.OrderByDescending(r => r.Score));
        }
