...
namespace Algorithm.B.WorkerService {
    public class Worker : BackgroundService {
        ...
        private const string path = @"R:/SolutionB/Model1.zip";
        private const string path2 = @"R:/SolutionB/Model2.zip";
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken) {
            ...
            await queueConsumerService.StartAsync(bo, RabbitMQConfiguration.SolutionBRoute, cancellationToken);
        }
        ...
        private async Task<bool> ProcessData(string sessionId) {
            ...
            if (totalItems <= Constants.PageSize) {
                ...
                var wynik = mlService.DetectAnomaliesBychangePoint(dataModel.ToList(), path);
                var wynik2 = mlService.DetectAnomaliesBychangePoint(dataModel.ToList(), path2);
